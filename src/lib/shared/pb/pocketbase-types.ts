...
export type CanonicalPatchesResponse<Tpatch = unknown, Texpand = unknown> = Required<
	CanonicalPatchesRecord<Tpatch>
> &
	BaseSystemFields<Texpand>;
export type CharactersResponse<Texpand = unknown> = Required<CharactersRecord> &
	BaseSystemFields<Texpand>;
export type DraftPatchesResponse<Tpatch = unknown, Texpand = unknown> = Required<
	DraftPatchesRecord<Tpatch>
> &
	BaseSystemFields<Texpand>;
export type EventChatsResponse<Tnotes = unknown, Texpand = unknown> = Required<
	EventChatsRecord<Tnotes>
> &
	BaseSystemFields<Texpand>;
...
> &
	BaseSystemFields<Texpand>;
export type StoriesResponse<Tbible = unknown, Texpand = unknown> = Required<StoriesRecord<Tbible>> &
	BaseSystemFields<Texpand>;
export type StoryEventsResponse<Texpand = unknown> = Required<StoryEventsRecord> &
	BaseSystemFields<Texpand>;
